...
public class MainActivity extends AppCompatActivity {
    ...
    private final float xCat = 400;
    private final float yCat = 700;
        ...
        public boolean onTouch(View view, MotionEvent motionEvent){
            ...
            switch (motionEvent.getAction()){
                case MotionEvent.ACTION_DOWN:
                    sDown= "Нажатие: координатат X = " + x +", координата y = "+ y;
                    sMove = "";
                    sUp = "";
                    break;
                 case MotionEvent.ACTION_MOVE:
                     sMove = "Движение: координата X = " + x + ", координта y = " + y;
                     ...
                     if (x < (xCat + deltaCat) && x > (xCat - deltaCat) && y< (yCat + deltaCat)){
                         ...
                         toast.setGravity((int) deltaCat, (int) xCat, (int)yCat);
                         toast.show();
                    ...
                    case MotionEvent.ACTION_UP:
                     case MotionEvent.ACTION_CANCEL:
                         sMove = "";
                         sUp = "Отпускание: координата X = " + x + ", координта y = " + y;
                         break;
            }
